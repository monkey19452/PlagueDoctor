...
<div id="main" class="wrapper style1">
					<div class="container">
						<header class="major">
                            <h2>Usuwanie Konta Użytkownika</h2>
						</header>
...
<body>
    ...
    div.x, p.q {
        ...
        <p class="q">Czy usunąć konto?</p>
        <br>
        <div class="x">
            <a href="delete-account-script.php" class="button primary"> Tak </a>

            <a href="welcome.php" class="button primary"> Nie </a>
        </div>          
