						...
						<div class="row gtr-150">
							<div class="col-4 col-12-medium">
								...
								<!-- Sidebar -->
									<section id="sidebar">
										<section>
											<h3>Dr Alban</h3>
											<p>Pełne Imię i Nazwisko: <i>"Doktor Alban"</i></p>
											<footer>
												<ul class="actions">
										...
										<hr />
										<section>
											<a href="#" class="image fit"><img src="images/alban.jpg" alt="" /></a>
											...
											<ul class="fa-ul">
												...
												<li><i class="fa-li fa fa-envelope"></i>alban@plaguedoctor.pl</li>
											  </ul>
							...
							<div class="col-8 col-12-medium imp-medium">
								...
								<style>
									...
									<section id="content">
										<h3>WYKSZTAŁCENIE:</h3>
										<p><span>&check;</span>    Akademia Muzyczna w Warszawie</p>
										<h3>UZYSKANE SPECJALIZACJE:</h3>
										<p><span>&check;</span>    Ortopedia i Stomatologia</p>
										<h3>DOŚWIADCZENIE ZAWODOWE:</h3>
										<p><span>&check;</span>    Festiwal Piosenki W Opolu</p>
										<p><span>&check;</span>    Szpital Czerniakowski w Warszawie</p>
										<h3>DODATKOWE UMIEJĘTNOŚCI/ SPECJALIZACJE:</h3>
										<p><span>&check;</span>    Taniec na Głowie</p>
										<h3>KOMUNIKACJA W JĘZYKU:</h3>
										<p><span>&check;</span>    Język angielski</p>
										<p><span>&check;</span>    Język bułgarski</p>
										
										<h3>Czym się zajmuje? </h3>
										<ul>
											<li> Złamania, skręcenia, stłuczenia i zwichnięcia np. głowy  </li>
											<li> Zdrapywanie Strupów  </li>
											<li> Różne schorzenia kręgosłupa </li>
											<li> Wady postawy </li>
											<li> Wróżenie z fusów</li>
										</ul>
