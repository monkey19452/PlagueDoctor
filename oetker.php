						...
						<div class="row gtr-150">
							<div class="col-4 col-12-medium">
								...
								<!-- Sidebar -->
									<section id="sidebar">
										<section>
											<h3>Dr Oetker</h3>
											<p>Pełne Imię i Nazwisko: <i>"Doktor Oetker"</i></p>
										...
										<hr />
										<section>
											<a href="#" class="image fit"><img src="images/oetker.jpg" alt="" /></a>
										
										
											<ul class="fa-ul">
												<li><i class="fa-li fa fa-home "></i>Portowa 11</li>
												<li><i class="fa-li fa fa-city "></i>84-150 Hel</li>
												<li><i class="fa-li fa fa-phone "></i>(58)305-67-22</li>
												<li><i class="fa-li fa fa-clock fa-spin"></i>9.00 - 17.00</li>
												<li><i class="fa-li fa fa-envelope"></i>oetker@plaguedoctor.pl</li>
											  </ul>
							...
							<div class="col-8 col-12-medium imp-medium">
								...
								<style>
									...
									<section id="content">
										<h3>WYKSZTAŁCENIE:</h3>
										<p><span>&check;</span>    Akademia Weterynaryjna w Elblągu</p>
										<p><span>&check;</span>    Licencjat Cukiernika</p>
										<h3>UZYSKANE SPECJALIZACJE:</h3>
										<p><span>&check;</span>    Kardiologia ogólna</p>
										<h3>DOŚWIADCZENIE ZAWODOWE:</h3>
										<p><span>&check;</span>    Szpital MSWiA w Gdańsku</p>
										<p><span>&check;</span>    Festiwal polskiej piosenki w Egiertowie</p>
										<p><span>&check;</span>    Uniwersyteckie Centrum Kliniczne w Gdańsku</p>
										<h3>DODATKOWE UMIEJĘTNOŚCI/ SPECJALIZACJE:</h3>
										<p><span>&check;</span>    RTL</p>
                                        <p><span>&check;</span>    EKG</p>
                                        <p><span>&check;</span>    PRL</p>
										<h3>KOMUNIKACJA W JĘZYKU:</h3>
										<p><span>&check;</span>    Język angielski</p>
                                        <p><span>&check;</span>    Język niemiecki</p>
										<p><span>&check;</span>    Teleporady w języku C</p>
										
										<h3>Czym się zajmuje? </h3>
										<ul>
											<li> Rozmawia ze zwierzętami  </li>
											<li> Ma zaburzenia rytmu serca  </li>
											<li> Ma zapalenie mięśnia sercowego </li>
											<li> Kolekcjonuje nabyte i wrodzone wady serca</li>
