...
<body class="is-preload landing">
            ...
            <header id="header">
                ...
                <nav id="nav">
                    <ul>
                        ...
                        <li><a href="login.php" class="button ">Zaloguj</a></li>
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                <label><br> </label>
                <input type="password" name="password" placeholder='Hasło' class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>">
            ...
            <br>
            <p>Nie masz konta? <a href="register.php">Zarejestruj sie teraz!</a>.</p>
        </form>
    </div>
